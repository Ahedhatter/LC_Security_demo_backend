...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "https://lc-security-backend-d51e9de3f86b.herokuapp.com/", "http://127.0.0.1:8001", "https://demo.lcsecurity.ai/", "https://demo-lcsecurity.lovable.app/", "chrome-extensions://efcdjkdffhbehmkegmpmopkglacllggo", "chrome-extension://dddfmnkdncldohpigmnogfefkolacplh"],  # React dev server, heroku hosting, local testing, lovable.dev projects and demo.lcsecurity.ai
